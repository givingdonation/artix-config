...
main = do
	...
	} `additionalKeysP` [("M-<XF86AudioRaiseVolume>", spawn "amixer -q sset Master 2%+"),("M-<XF86AudioLowerVolume>", spawn "amixer -q sset Master 2%-"),("M-<XF86AudioMute>", spawn "amixer set Master toggle"), ("M-s", spawn "slock")]
